...
const TOOL_GUIDES = {
  "10년 후 해외여행 자금 설계하기": {
    purpose: "현재 여행비에 물가와 환율 변화를 적용해 10년 뒤 필요한 원화 금액을 구하고, 적금 상품별 월 납입액과 예상 이자를 비교하는 경제 수학 수행평가 도구입니다.",
    preparation: "학생은 학급·번호·이름을 입력한 뒤 여행지와 일정, 소비 수준, 적금 상품과 비교 기준을 선택합니다. 원화 강세·기준·원화 약세 중 하나가 무작위로 정해집니다.",
    studentSteps: "학생 정보 입력 → 여행지와 일정 선택 → 여행비 확인 → 무작위 환율 상황 해석 → 적금 상품 비교 → 선택 기준 결정 → 제출 보고서 저장",
    flow: "현재 여행비 → 복리 물가 상승 → 외화 환산 → 환율 시나리오 → 10년 적금의 월 납입액과 이자 → 선택 근거와 최종 해석",
    teacherTips: "서술 부담을 줄이기 위해 선택 결과가 계획과 해석 문장으로 자동 정리됩니다. 제출 전에는 학급·번호·이름과 모든 선택 결과가 갖추어졌는지 확인합니다.",
    questions: "물가는 같아도 환율 상황에 따라 필요한 원화가 왜 달라지나요? 표시 금리가 가장 높은 상품과 월 납입액이 가장 적은 상품이 다를 수 있는 이유는 무엇인가요?",
    cautions: "관광세·숙박세, 환전 수수료와 환율 스프레드, 이자소득세를 제외한 교육용 단순화 모형입니다. 무작위 환율 상황은 초기화 전까지 유지됩니다."
  },
  "페르미 추정 수행평가": {
